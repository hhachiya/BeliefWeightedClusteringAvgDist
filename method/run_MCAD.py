...
def generate_random_color(c):
	...
	#colorlist = ['#e6194b','#3cb44b','#ffe119','#0082c8','#f58231','#911eb4','#46f0f0','#f032e6','#d2f53c','#fabebe','#008080','#e6beff','#aa6e28','#fffac8','#000008','#aaffc3','#808000','#ffd8b1']
...
def confClusteringPredict(cropLaser, laser, bb, gamma=-1, isCombine=True, isPlot=True):
	...
	if isPlot:
		...
		#plt.plot([aPoint[0],cPoint[0],bPoint[0]],[aPoint[1],cPoint[1],bPoint[1]],lineStyle='-',color='red',linewidth=5)
